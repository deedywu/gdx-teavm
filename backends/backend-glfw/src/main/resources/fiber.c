 ...
 * the TeaVM native runtime expects fiber timing hooks and locale initialization.
 * We keep the GLFW-target override here so all GLFW native apps get the same
 * macOS behavior without depending on optional extensions.
 */
#include "fiber.h"
